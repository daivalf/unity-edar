...
{
    public GameObject jawaban1, jawaban2, jawaban3, jawaban4, jawaban5, jawaban6, pilihan1, pilihan2, pilihan3, pilihan4, pilihan5, pilihan6;

    Vector2 pilihan1InitialPos, pilihan2InitialPos, pilihan3InitialPos, pilihan4InitialPos, pilihan5InitialPos, pilihan6InitialPos;

    public bool pilihan1Correct, pilihan2Correct, pilihan3Correct, pilihan4Correct, pilihan5Correct, pilihan6Correct = false;
    ...
    void Start()
    {
        ...
        pilihan6InitialPos = pilihan6.transform.position;
    }
    ...
    public void DragPilihan6()
    {
        pilihan6.transform.position = Input.mousePosition;
    }
    ...
    public void DropPilihan6()
    {
        ...
        {
            pilihan6.transform.position = pilihan6InitialPos;
        }
    }

    public void CekHasil()
    {
        if (pilihan1Correct && pilihan2Correct && pilihan3Correct && pilihan4Correct && pilihan5Correct && pilihan6Correct)
        {
            showPopupBerhasil();
        }
        else
